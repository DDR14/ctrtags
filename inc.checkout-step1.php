<header class="success">
      <div class="container">
            <div class="col-lg-12">
                <?php echo '<img class="img-responsive" src="../build/img/delivery_truck.png" width="300px" height="300px" alt="">';?>
                <div class="intro-text">
                    <span class="name">Step 1 of 3 - Delivery Information</span>
                    <hr class="star-light">
                </div>
            </div>
        </div>
    ...
    <form  name="myForm2" method="post" action="functions/saveshipping.php" onsubmit="return validateForm()">
      ...
      <div class="col-lg-5">
        ...
        <table class="table table-striped">
            ...
            <tr>
              <td><input type="radio" name="shipping" value="table_table" id="ship-table-table" /><label for="ship-table-table" class="checkboxLabel" ><?php echo $country;?></label></td>
              <td>$45.95</td>
            </tr>
        </table>
        <div class="alert alert-warning">
