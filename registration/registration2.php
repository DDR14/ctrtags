...
<?php $corespondent='CTR Tags';
$lccorespondent = strtolower($corespondent);
?>

<form id="myform" name="myForm" method="post" action="registration/registrationexec.php" onsubmit="return validateForm()">
                          <div class="col-md-6">
                                      ...
                                      <p>If you at all believe that this may be an issue, please assign a personal email for <?php echo $corespondent;?> correspondence.</p>
                                          ...
                                          <input type="text" onkeypress='validate(event)' required class="form-control" id="phone" name="telephone" ></input>
                                          <label>Fax Number:</label>
                                          <input class="form-control" name="fax" onkeypress='validate(event)'></input>
                                          ...
                                          <label>Password: <?php if (isset($_SESSION['err'])){ echo "<strong style='color:red;'>* Password Not Match!</strong>"; }else{echo "";}?></label>
                                          <input required type="password" class="form-control" name="pass" id="passWord"></input>
                                          <label>Confirm Password:</label>
                                          <input required type="password" class="form-control" name="confirm_password"></input>
                            </div> <!-- colmd6 -->
                            <div class="col-md-6">
