    <header>
       <div class="container">
            <div class="col-lg-12">
                <img class="img-responsive" src="../build/img/products.png" width="300px" height="300px" alt="<?php echo $brand;?> LDS Primary Tags">
                <div class="intro-text">
                    <span class="name"><h1>CTR Tags Accessories</h1></span>
                    <hr class="star-light">
                </div>
            </div>
            <?php 
             echo '<div class="row">';
                $query4=mysql_query("SELECT * FROM zen_categories WHERE parent_id='93'");
                ...
                echo '<div class="col-sm-4 portfolio-item text-center">';
                    echo '<a href="specificproducts.php?cPath='.$categories_id.'&&product=accessories" class="portfolio-link" data-sound="alert" data-toggle="modal">';
...
<section id="contact">
    ...
    $cPath=$_GET['cPath'];
             echo '<div class="row">';
                $query4=mysql_query("SELECT * FROM zen_categories WHERE parent_id='$cPath'");
                while($row4=mysql_fetch_array($query4)){
